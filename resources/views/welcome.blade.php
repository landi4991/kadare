...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Fondi-Shtëpia Kadare</title>
...
Më poshtë gjeni një listë të librave të Bibliotekës Kadare, së bashku me specifikimet dhe veçoritë përkatëse.</p>
    ...
    <form class="d-flex search-form" action="{{route('search_book')}}" method="GET">
    ...
    <div id="sidebar-footer" class="footer-widgets" role="complementary">
        <div class="container">
            <div class="row">
                    ...
                    <div class="textwidget"><p><img loading="lazy" class="alignnone size-full wp-image-226" src="http://shtepiakadare.tirana.al/wp-content/uploads/2019/12/LOGO.jpg" alt="" width="64" height="67"></p>
</div>
        </section>  
